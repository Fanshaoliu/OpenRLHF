...
from openrlhf.datasets import RewardDatasetNCE, RewardDataset
...
def train(args):
    ...
    if str(args.method).startswith('nce'):
        print("Preprocessing nce dataset...")
        train_dataset = RewardDatasetNCE(
            train_data,
            tokenizer,
            args.max_len,
            strategy,
            input_template=args.input_template,
            n_fake_prompt=int(args.n_fake_prompt),
            nce_hard_level=args.nce_hard_level,
            nce_grad_type=args.nce_grad_type
        )
    else:
    ...
    unwrap_model.config.log_b_score_head_prefix = "b_score"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tau", type=float, default=0.05, help="Lambda for CMI loss")
    parser.add_argument("--method", type=str, default=None, help="method")
    parser.add_argument("--n_fake_prompt", type=int, default=3, help="n_fake_prompt")
    parser.add_argument("--nce_hard_level", type=str, default=None, help="nce_hard_level")
    parser.add_argument("--nce_grad_type", type=str, default=None, help="nce_grad_type")
    # Estimation variance

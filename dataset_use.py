...
dataset = blending_datasets(
    "/mnt/data/user/liu_shaofan/RMB-Reward-Model-Benchmark/RMB_dataset/Pairwise_set/Harmlessness/S1.json",
    probabilities="1",
    strategy=None,
    seed=42,
    max_count=1e8,
...
train_data = dataset.select(range(min(max_samples, len(dataset))))
print(train_data)

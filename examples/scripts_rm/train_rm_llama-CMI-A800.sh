    ...
    for split in hh_nce ; do
        ...
        for tau in 1.0 ; do
            for lambda in 0.05 0.1 ; do
                ...
                exp_postfix="${exp_postfix}-${nce_hard_level}-${nce_grad_type}"
        # for tau in 0.2 ; do
        #     for lambda in 0.05 ; do
                ...
                # --pretrain /mnt/data/user/liu_shaofan/OpenRLHF/checkpoint/${pretrain}
                --pretrain /mnt/data/user/liu_shaofan/OpenRLHF/checkpoint/llama3.1-8B-pretrain_ShareGPT_V3_unfiltered_cleaned_split
                --bf16
                --max_epochs 1
                --max_len 2048
                --zero_stage 3
                ...
                --disable_ds_ckpt
                --max_ckpt_num 100
                --wandb_project "cmi_rm_exp-llama3.1_8B"

...
training_commands=(
  ...
  --eval_ckpt_dir "checkpoint/llama3.2-1B-sft-hh_cm_avg5_1-6-rm-baseline-0.0-tau_1.0-rs_42-rm_mechanism_in_avg5-hf_ckpt checkpoint/llama3.2-1B-sft-hh_cm_avg5_2-7-rm-baseline-0.0-tau_1.0-rs_42-rm_mechanism_in_avg5-hf_ckpt checkpoint/llama3.2-1B-sft-hh_cm_avg5_3-8-rm-baseline-0.0-tau_1.0-rs_42-rm_mechanism_in_avg5-hf_ckpt checkpoint/llama3.2-1B-sft-hh_cm_avg5_4-9-rm-baseline-0.0-tau_1.0-rs_42-rm_mechanism_in_avg5-hf_ckpt checkpoint/llama3.2-1B-sft-hh_cm_avg5_5-10-rm-baseline-0.0-tau_1.0-rs_42-rm_mechanism_in_avg5-hf_ckpt"
...
if [[ ${1} != "slurm" ]]; then
  CUDA_VISIBLE_DEVICES=4,5 deepspeed --master_port 29510 --module "${training_commands[@]}"
fi
